...
const ExploreMore = () => {
  ...
  const handleClick = (event) => {
    ...
    return (
      <Fragment>
 <div className="text-richblack-800 bg-richblack-50 h-[65px] font-[600] text-lg rounded-[0.7rem] pl-8 pr-8 flex mt-5 mx-auto w-full md:w-[50%] items-center justify-around">
  <button
    key={1}
